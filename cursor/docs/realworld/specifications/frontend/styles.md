...
Instead of having the Bootstrap theme included locally, we recommend loading the precompiled theme from our CDN (our [header template](./templates.md#header-for-unauthenticated-users) does this by default):
